...
class Products with ChangeNotifier {
  ...
  Future<void> fetchProduct([bool filterByUser = false]) async {
    ...
    String url =
        'https://flat-chat-a738a-default-rtdb.firebaseio.com/products.json?auth=$authToken$filterString';
    ...
    try {
      ...
      url =
          'https://flat-chat-a738a-default-rtdb.firebaseio.com/userFavorites/$userId.json?auth=$authToken';
  ...
  Future<void> addProduct(Product product) async {
    final url =
        'https://flat-chat-a738a-default-rtdb.firebaseio.com/products.json?auth=$authToken';
  ...
  Future<void> editProduct(String id, Product product) async {
    ...
    if (productIndex >= 0) {
      final url =
          'https://flat-chat-a738a-default-rtdb.firebaseio.com/products/$id.json?auth=$authToken';
