          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromRGBO(121, 186, 53, 1.0).withOpacity(0.9),
                  Color.fromRGBO(245, 245, 152, 1.0).withOpacity(0.9),
                ],
                  ...
                  Flexible(
                    child: Container(
                      ...
                      transform: Matrix4.rotationZ(-6 * pi / 180)
                        ..translate(-10.0),
                      // ..translate returns void transform expects Matrix4
                      decoration: BoxDecoration(
...
class _AuthCardState extends State<AuthCard>
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (e.toString().contains('PASSWORD_WEAK'))
